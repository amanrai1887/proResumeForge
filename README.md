...
ProResumeForge is a powerful open-source resume builder.

The goal of ProResumeForge is to provide everyone with free access to a modern professional resume design and enable anyone to apply for jobs with confidence.

Official site: [https://proresumeforge.vercel.app/](https://proresumeforge.vercel.app/)

## ⚒️ Resume Builder

ProResumeForge's resume builder allows user to create a modern professional resume easily.
...
| **5. Successful Track Record** | ProResumeForge users have landed interviews and offers from top companies, such as Dropbox, Google, Meta to name a few. It has been proven to work and liken by recruiters and hiring managers. |

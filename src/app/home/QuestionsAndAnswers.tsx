...
const QAS = [
    ...
    answer: (
      <>
        ...
        <p>
          ...
          ProResumeForge saves time and prevents formatting mistakes by
  ...
  {
    question:
      "Q2. What uniquely sets ProResumeForge apart from other resume builders and templates?",
    answer: (
      <>
        <p>
          Other than ProResumeForge, there are some great free resume builders out
          there, e.g. <Link href="https://rxresu.me/">Reactive Resume</Link>,{" "}
          <Link href="https://flowcv.com/">FlowCV</Link>. However, ProResumeForge
          stands out with 2 distinctive features:
        </p>{" "}
        <p>
          <span className="font-semibold">
            1. ProResumeForge is designed specifically for the U.S. job market and
            best practices.
          </span>
          <br />
          Unlike other resume builders that target a global audience and offer
          many customization options, ProResumeForge intentionally only offers
          ...
          like references. Additionally, ProResumeForge only offers a top down
          single column resume design as opposed to two column design, because
          single column design works best for AST. <br />{" "}
        </p>
        <p>
          <span className="font-semibold">
            2. ProResumeForge is super privacy focus.
          </span>{" "}
          <br />
          While other resume builders may require email sign up and store user
          data in their databases, ProResumeForge believes that resume data should
          remain private and accessible only on user’s local machine. Therefore,
          ProResumeForge doesn’t require sign up to use the app, and all inputted
  ...
  {
    question: "Q3. Who created ProResumeForge and why?",
    answer: (
      <p>
        ProResumeForge was created by{" "}
        ...
        that led to ProResumeForge, where we integrated best practices and our
        knowledge into this resume builder. Our hope is that ProResumeForge can help
  ...
  {
    question: "Q4. How can I support ProResumeForge?",
    answer: (
      <>
        <p>
          The best way to support ProResumeForge is to share your thoughts and
        ...
        <p>
          Another great way to support ProResumeForge is by spreading the words.
